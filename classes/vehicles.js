...
class Car extends GameObject {
  constructor(p, x, y, stats) {
    ...
    // Gear simulation
    this.gearMultipliers = [0.05, 0.07, 0.09, 0.035, .008, -0.06];
    this.maxRPM = 8000;
    this.idleRPM = 1000;
  ...
  update() {
    ...
    let lerpAmount = 1;
    // I NEED TO MAKE THIS BASED OFF SPEED AND TRACTION
